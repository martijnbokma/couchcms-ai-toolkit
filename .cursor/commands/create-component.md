...
Create a component bundle in `snippets/components/`:

1. **Component file**: `snippets/components/{name}.html`
2. **Optional CSS**: `assets/css/components/{name}.css`
3. **Optional TypeScript**: `assets/ts/components/{name}.ts`

## Template

```html
<!-- snippets/components/{name}.html -->
<cms:embed 'snippets/layouts/base.html' />
...
**Output**: Creates `snippets/components/card.html` with:
