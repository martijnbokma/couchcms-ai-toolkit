...
**🚀 ALWAYS PERFORM AUTOMATIC ANALYSIS:**
...
6. **📊 Analyze project complexity** and recommend appropriate prompt versions
7. **🔧 Check best practices directory** for project-specific guidelines
8. **🌐 Cross-reference with Context7** for latest industry standards
9. **📈 Generate comprehensive analysis report** with actionable recommendations

### Phase 2: Automatic Initial Assessment

**🚀 ALWAYS PERFORM INITIAL SCAN:**
...
**🚀 ALWAYS PERFORM COMPREHENSIVE REVIEW:**
...
2. **📝 Content Quality Assessment**
    ...
    - ✅ Cross-reference with best practices directory
    - ✅ Validate against Context7 industry standards
...
3. **🎯 Actionability Assessment**
    ...
    - ✅ Ensure executable instructions for project context
...
4. **🤖 Agent Comfort Evaluation**
    ...
    - ✅ Evaluate AI agent usability and effectiveness

### Phase 4: Automatic Project Complexity Analysis & Prompt Recommendation

**🚀 ALWAYS PERFORM COMPLEXITY ANALYSIS:**

Based on standards.md analysis, the validator automatically determines appropriate prompt complexity:

**Project Type Analysis:**

- **couchcms-webapp**: Simple to moderate complexity, student-focused → **Simple prompts recommended**
- **enterprise-webapp**: High complexity, multiple teams → **Complex prompts recommended**
- **spa-framework**: Moderate complexity, modern architecture → **Balanced prompts recommended**
- **static-site**: Low complexity, content-focused → **Simple prompts recommended**
...
- ✅ **Recommend**: `javascript-refactor.md` (84 lines, 5 steps)
- ❌ **Avoid**: `javascript-refactor.md` (701 lines, 8 steps) - Overkill for this project type
...
**🚀 ALWAYS GENERATE COMPREHENSIVE SCORING:**

The validator automatically calculates detailed scores and provides recommendations:

```
Total Score = (Standards Analysis × 0.15) + (Best Practices × 0.15) + (Structure × 0.15) +
              (Technical × 0.15) + (Clarity × 0.15) + (Actionability × 0.15) + (Standards Compliance × 0.1)
...
**🚀 ALWAYS PERFORM FINAL CONTROL & VALIDATION:**
...
```
Comfort Score = (Context Clarity × 0.25) + (Instruction Clarity × 0.25) +
                (Step Progression × 0.25) + (Error Prevention × 0.25)
...
- ✅ **Recommended Prompt**: [Specific prompt file with rationale]
- ❌ **Avoid**: [Overkill prompts with explanation]
...
- [ ] **Quality Gates Passed**: All final quality gates met (Overall Score ≥ 80, Comfort Score ≥ 80)
...
### 🚀 Automatic Analysis for Any Project with standards.md

**The validator ALWAYS performs comprehensive analysis automatically:**

1. **🔍 Standards Analysis**: Automatically parses standards.md and extracts project configuration
2. **📋 Best Practices Verification**: Automatically checks docs/\_prompts/best-practices/ directory
3. **🌐 Context7 Cross-Reference**: Automatically uses Context7 API to verify latest industry standards
4. **📊 Complexity Analysis**: Automatically determines appropriate prompt complexity level
5. **🎯 Prompt Recommendation**: Automatically suggests the most suitable prompt version for your project
6. **✅ Comprehensive Validation**: Automatically validates prompts against parsed standards and best practices
7. **🔍 Control & Validation Check**: Automatically performs final control step to ensure everything went well
8. **🤖 Agent Comfort Assessment**: Automatically maximizes AI agent comfort and usability
9. **📈 Detailed Reporting**: Automatically generates comprehensive analysis reports with actionable recommendations
...
- ✅ **Recommended**: `javascript-refactor.md` (84 lines, 5 steps)
- ❌ **Avoid**: `javascript-refactor.md` (701 lines, 8 steps) - Overkill
...
2. 📋 Check docs/prompts/best-practices/ for project-specific guidelines
3. 🌐 Use Context7 API to verify latest industry standards
4. 📊 Analyze project complexity and user base
5. 🎯 Recommend appropriate prompt complexity level
6. 📝 Extract technology stack and coding standards
7. ✅ Validate prompt against parsed standards and modern best practices
8. 🚨 Identify outdated or deprecated practices
9. 🔍 Perform comprehensive control & validation check
10. 🤖 Assess and maximize AI agent comfort
11. 📈 Provide project-specific recommendations with modernization suggestions
12. 📊 Generate comprehensive scoring and actionable feedback
```
